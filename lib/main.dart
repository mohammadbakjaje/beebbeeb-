...
import 'package:untitled1/Screens/Driver/ChangeStatusCubit/change_status_cubit.dart';
import 'package:untitled1/Screens/Driver/ShowDriverCubit/Show_Driver_cubit.dart';
import 'package:untitled1/Screens/Driver/login_driver/bloc_login/login_cubit_driver.dart';
import 'package:untitled1/Screens/Driver/login_page_driver.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
            create: (BuildContext context) => UpdateOrderStatusCubit()),
        BlocProvider(create: (BuildContext context) => InProgressOrdersCubit()),
        ...
        BlocProvider(create: (context) => DriverRegisterCubit()),
        BlocProvider(create: (context) => DriverLoginCubit()),
